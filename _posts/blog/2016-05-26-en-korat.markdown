...
I saw this [article](https://www.liquidlight.co.uk/blog/article/creating-svg-sprites-using-gulp-and-sass/ "Liquid Light’s blog (new window)"){:target="_blank"}{:rel="noopener"}
...
To save some extra time, I added the [LiveReload module](https://www.npmjs.com/package/gulp-livereload "Live reload on NPM (new window)"){:target="_blank"}{:rel="noopener"} which automatically refreshes the browser as soon as a CSS or JS change is made to the project.
