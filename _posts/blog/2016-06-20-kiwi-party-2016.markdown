...
[Voir les slides de la conférence Nos petits stress quotidiens](https://speakerdeck.com/hiwelo/nos-petits-stress-quotidiens-kiwiparty-2016 "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
...
[Voir la vidéo de la conférence 10 astuces SVG](https://vimeo.com/179313779 "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
...
[Voir les slides de la conférence Mettez du libre dans vos projets](http://fr.slideshare.net/Rudloff/mettez-du-libre-dans-vos-projets-web "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
...
[Exemple de site créé avec un générateur de site statique](https://mademistakes.com/style-guide/ "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}

[Voir la vidéo de la conférence Agilité pour petits projets](https://vimeo.com/179314577 "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
...
Pour éviter une spécificité trop importante, on peut utiliser les outils [CSS Specificity](http://cssspecificity.com "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"} ou [Specificity Calculator](http://specificity.keegan.st/ "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
...
[Voir la vidéo de la conférence Intégration et Webapps : ProTips](https://vimeo.com/179315043 "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}

### Git ProTips

Christophe Porteneuve a fait un vrai show pour nous donner quelques commandes Git. Tout est dans la vidéo ci-dessous :

[Vidéo de la conférence Git ProTips sur Vimeo](https://vimeo.com/179446529 "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
...
Il a aussi présenté des outils très utiles pour avoir un état des lieux de la sécurité de notre site/serveur avec [Qualys](https://www.ssllabs.com/ "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"} ou [acme.sh](https://github.com/Neilpang/acme.sh "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
[Voir la vidéo de la conférence HTTPS partout, chiche !](https://vimeo.com/179446532 "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
...
[Voir la vidéo de la conférence L’email dans toutes ses formes](https://vimeo.com/180578382 "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
...
[Voir la vidéo de la conférence Les codes rewiewztraminer : contrairement au vin, c’est moins bon en tardive](https://vimeo.com/180578384 "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
...
[Voir la vidéo de la conférence Workflow moderne cherche graphiste à l’ancienne](https://vimeo.com/181158986 "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
...
[Voir la vidéo de la conférence CSS Selector Wars : un nouvel espoir ?](https://vimeo.com/182053671 "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}
...
[Voir la vidéo de la conférence L’identité visuelle sur le web, penser au-delà du print](https://vimeo.com/181158992 "(nouvelle fenêtre)"){:target="_blank"}{:rel="noopener"}